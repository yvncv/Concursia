...
export const brandName = "SWGEMN"

export default function LandingPage() {
  const { events } = useEvents();
  const pastEvents = events.filter(event => event.endDate.toDate() < new Date(Date.now()))
      ...
      <main>
        ...
        <section className="relative h-[200px] sm:h-[450px] flex items-center justify-center w-full">
          ...
          <div className="relative z-1 text-center text-white px-4">
            <h1 className="text-sm md:text-5xl font-bold mb-4">Vive la Pasión de la Marinera Norteña</h1>
            <p className="text-sm md:text-xl mb-4 mx-5 md:mb-8">Descubre los mejores eventos y competencias en Perú</p>
            <Link href={"/calendario"} className="text-sm md:g-rojo bg-rojo p-1 md:p-2 rounded-lg text-white">Ver Eventos</Link>
          </div>
        </section>
        ...
        <section id="eventos" className="py-16 bg-gray-100">
          <div className="container mx-auto px-4">
            {pastEvents.length > 0 ? (
              <>
                <h2 className="text-3xl font-bold text-center mb-8">Eventos Recientes</h2>
        ...
        <section id="galeria" className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <p className="text-center">No hay eventos registrados para mostrar en esta sección.</p>
            )}
          </div>
        </section>
        ...
        <section id="contacto" className="py-16">
          <div className="container mx-auto px-4">
            ...
            <form className="max-w-md mx-auto">
              <div className="mb-4">
                <input type="text" placeholder="Nombre" className="w-full p-2 rounded-lg" />
              </div>
              <div className="mb-4">
                <input type="email" placeholder="Correo electrónico" className="w-full p-2 rounded-lg" />
              </div>
              <div className="mb-4">
                <textarea placeholder="Mensaje" className="w-full p-2 rounded-lg" />
              </div>
              <button type="submit" className="bg-rojo hover:bg-red-800 p-2 rounded-lg text-white w-full">Enviar Mensaje</button>
            </form>
          </div>
        </section>
      </main>
