        ...
        <section id="contacto" className="py-16">
          <div className="container mx-auto px-4 max-w-screen-md">
            ...
            <form className="space-y-4">
              <input type="text" placeholder="Nombre" className="w-full p-2 rounded-lg border" />
              <input type="email" placeholder="Correo electrónico" className="w-full p-2 rounded-lg border" />
              <textarea placeholder="Mensaje" className="w-full p-2 rounded-lg border"></textarea>
              <button
                type="submit"
