...
const AdminSideBar: React.FC<AdminSideBarProps> = ({ isCollapsed, setIsCollapsed }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar principal */}
      <aside className={`${isCollapsed ? "w-16" : "w-64"} fixed top-0 left-0 h-full bg-white shadow-md z-40 transform transition-all duration-300 md:translate-x-0`} >
        ...
        <div className="p-4">
          {!isCollapsed && (
            <h1 className="text-xl font-bold text-red-700 mb-6">Administrador</h1>
          )}
          <nav>
