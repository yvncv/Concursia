...
const LocationInformation: React.FC<Props> = ({ locationData }) => {
    const placeItems = [
        { label: 'Departamento', value: locationData?.department || 'N/A' },
        { label: 'Provincia', value: locationData?.province || 'N/A' },
        { label: 'Distrito', value: locationData?.district || 'N/A' },
    ];
